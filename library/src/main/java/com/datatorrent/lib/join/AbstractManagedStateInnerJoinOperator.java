    ...
    Operator.CheckpointNotificationListener, Operator.CheckpointListener,Operator.IdleTimeHandler
{
  ...
  public class ManagedSpillableComplexComponent implements SpillableComplexComponent
  {
    ...
    @Override
    public <K, V> SpillableByteMap<K, V> newSpillableByteMap(long bucket, Serde<K, Slice> serdeKey, Serde<V, Slice> serdeValue)
    {
      throw new UnsupportedOperationException();
    }

    @Override
    public <K, V> SpillableByteMap<K, V> newSpillableByteMap(byte[] identifier, long bucket, Serde<K, Slice> serdeKey, Serde<V, Slice> serdeValue)
    {
      throw new UnsupportedOperationException();
    }

    @Override
    public <K, V> SpillableByteArrayListMultimap<K, V> newSpillableByteArrayListMultimap(long bucket, Serde<K, Slice> serdeKey, Serde<V, Slice> serdeValue)
    {
      throw new UnsupportedOperationException();
    }

    @Override
    public <K, V> SpillableByteArrayListMultimap<K, V> newSpillableByteArrayListMultimap(byte[] identifier, long bucket, Serde<K, Slice> serdeKey, Serde<V, Slice> serdeValue)
    {
      return new ManagedTimeStateMultiValue<>();
    }

    public <K, V> SpillableByteArrayListMultimap<K, V> newSpillableByteArrayListMultimap(ManagedTimeStateImpl store, boolean isPrimaryKey)
    {
      return new ManagedTimeStateMultiValue<K,V>(store, isPrimaryKey);
    }

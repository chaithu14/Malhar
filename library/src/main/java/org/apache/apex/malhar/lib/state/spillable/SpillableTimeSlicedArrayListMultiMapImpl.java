    ...
    Spillable.SpillableComponent
{
      ...
      Serde<K> keySerde, Serde<V> valueSerde, @NotNull TimeExtractor timeExtractor, @NotNull KeyBucketExtractor keyBucketExtractor)
  {
    ...
    map = new SpillableTimeSlicedMapImpl<>(store, identifier, new PassThruSliceSerde(), new IntSerde(), timeExtractor, keyBucketExtractor);
  }
  ...
  private SpillableTimeSlicedArrayListImpl<V> getHelper(@Nullable K key)
  {
    ...
    if (spillableArrayList == null) {
      ...
      spillableArrayList = new SpillableTimeSlicedArrayListImpl<V>(keyValueSerdeManager.serializeDataKey(key, false).toByteArray(), store, valueSerde, timeExtractor, keyBucketExtractor);
  ...
  public boolean put(@Nullable K key, @Nullable V value)
  {
    ...
    if (spillableArrayList == null) {
      ...
      spillableArrayList = new SpillableTimeSlicedArrayListImpl<V>(keyPrefix.toByteArray(), store, valueSerde, timeExtractor, keyBucketExtractor);

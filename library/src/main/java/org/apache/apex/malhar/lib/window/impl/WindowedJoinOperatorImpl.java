...
/**
 * Windowed Join Operator to join two streams together. It aggregates tuple from two
 * input streams, perform join operation base on its join accumulation, and output one

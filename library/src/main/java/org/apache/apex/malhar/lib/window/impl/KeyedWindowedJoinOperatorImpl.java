...
/**
 * Keyed Windowed Join Operator to join two streams of keyed tuple with a key. Please use
 * {@link WindowedJoinOperatorImpl} for non-keyed joining.
 *
 * @param <KeyT> Type of the key used to join two streams.

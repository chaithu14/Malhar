...
/**
 * Example application to show usage of Windowed Join Operator. Two generators send out two streams of integers,
 * the join operator will do a co-group to join all income tuples and send output to collector and output to console.

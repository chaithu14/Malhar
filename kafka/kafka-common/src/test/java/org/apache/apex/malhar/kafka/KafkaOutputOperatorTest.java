...
public abstract class KafkaOutputOperatorTest
{
  String testName;
  ...
  public abstract AbstractKafkaExactlyOnceOutputOperator createKafkaExactlyOnceOutput();
  ...
  {
    AbstractKafkaExactlyOnceOutputOperator<Person> kafkaOutput = createKafkaExactlyOnceOutput();
  ...
  private List<Person> ReadFromKafka()
  {
    ...
    // Create KafkaSinglePortStringInputOperator
    AbstractKafkaInputOperator node = dag.addOperator("Kafka input", createKafkaInputOperator());

...
public class POJOTimeBasedJoinOperatorTest
{
  ...
  @Test public void testInnerJoinOperator() throws IOException, InterruptedException
  {
    Kryo kryo = new Kryo();
    POJOJoinOperator oper = new POJOJoinOperator();
    oper.setLeftStore(new HDHTBasedStore(200, "buckets/UP/", 1));
    oper.setRightStore(new HDHTBasedStore(200, "buckets/DOWN/", 1));
  ...
  @Test public void testLeftOuterJoinOperator() throws IOException, InterruptedException
  {
    Kryo kryo = new Kryo();
    POJOJoinOperator oper = new POJOJoinOperator();
    oper.setLeftStore(new HDHTBasedStore(200, "buckets/UP/", 1));
  ...
  @Test public void testRightOuterJoinOperator() throws IOException, InterruptedException
  {
    Kryo kryo = new Kryo();
    POJOJoinOperator oper = new POJOJoinOperator();
    oper.setLeftStore(new HDHTBasedStore(200, "buckets/UP/", 1));
  ...
  @Test public void testFullOuterJoinOperator() throws IOException, InterruptedException
  {
    Kryo kryo = new Kryo();
    POJOJoinOperator oper = new POJOJoinOperator();
    oper.setLeftStore(new HDHTBasedStore(200, "buckets/UP/", 1));

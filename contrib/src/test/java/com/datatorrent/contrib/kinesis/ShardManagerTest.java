...
public class ShardManagerTest extends KinesisOperatorTestBase
{
  ...
  public void testPartitionableInputOperator(KinesisConsumer consumer) throws Exception{
    ...
    PartitionableKinesisSinglePortStringInputOperator node = dag.addOperator("Kinesis consumer", PartitionableKinesisSinglePortStringInputOperator.class);
    ...
    node.setStrategy(AbstractPartitionableKinesisInputOperator.PartitionStrategy.MANY_TO_ONE.toString());
    ...
    // Wait 30s for consumer finish consuming all the records

...
This is the abstract implementation which is using 0.9 new consumer API that serves as base class
for consuming messages from Kafka messaging system. This operator has key features like fault-tolerant, scalable, multi-cluster support, multi-topic support.
This class doesn’t have any ports. 

#### Pre-requisites

This operator referred the Kafka Consumer API of version
0.9.0. So, this operator will work with any 0.9.x version of Apache Kafka.

...
### 0.8.x Version of Kafka Input Operator
...
### 0.9.0 Version of Kafka Input Operator

### AbstractKafkaInputOperator (Package: org.apache.apex.malhar.kafka)

This version uses the new 0.9.0 version of consumer API and features of this version are described here. This operator is fault-tolerant, scalable, multi-cluster and multi-topic support.
